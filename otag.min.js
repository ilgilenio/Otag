...
a.forEach(function(a){a instanceof Element||(a=a.init());this.appendChild(a)},this));return this},has:function(a,b){if(a){this.View||(this.View={});if(a instanceof Array&&!(a[0]instanceof Element)){var c=[];for(i in a)c.push("d".has(a[i])),a[i].parent=this,O.combine(this.View,a[i]);a=c}if("object"!=typeof a||a instanceof Element)a=[a];a instanceof Object&&(a=(a._?"function"==typeof a._?Object.keys(a).filter(function(b){return a[b]instanceof Element}).sort(a._):a._:Object.keys(a)).map(function(b){"function"==
